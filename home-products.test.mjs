...
test('product rows preserve partner links, escape titles and deduplicate',async()=>{
  const html=await homeProducts({list:async()=>({products:[{id:'one',image:'https://example.com/p.png',name:'<img onerror=bad>',retailCents:2300,supplierPrice:'2.00'}]})},'/shop/home-helper');
