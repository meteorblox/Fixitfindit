...
Launch remains closed. Production draft submission has not been exercised against a real customer order. The private owner screen at /owner/orders lists paid live orders, holds, CJ references and saved tracking; customer tracking presentation is still outstanding. Supplier actions still use the private CLI. Manual payment is not automatic order submission, and no background polling or notifications are configured by this change.
