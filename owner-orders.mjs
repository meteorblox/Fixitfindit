...
export function ownerOrdersPage(rows=null,message='',csrf=''){
...
export function createOwnerOrdersRoute({access,orders,worker}){
 return async(req,res,url)=>{
  ...
  const page=(rows=null,message='')=>{res.setHeader('Set-Cookie','fit_owner_csrf='+csrf+'; Path=/owner/orders; HttpOnly; Secure; SameSite=Strict; Max-Age=28800');return ownerOrdersPage(rows,message,csrf);};
