...
export const selectedProducts = [
  ...
  {slug:'waterfall-faucet-attachment', lookup:{pid:'1696373349800226816'}, category:'kitchen', name:'Rotating Waterfall Faucet Attachment', retailCents:1700, origin:'CN', optionNote:'Single attachment. Color and faucet compatibility confirmation pending.'}
];
