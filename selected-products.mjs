...
export const selectedProducts = [
  {slug:'electric-baking-pan', lookup:{pid:'2502240123311602100'}, category:'kitchen', name:'30 cm Electric Baking Pan',checkoutHold:true, retailCents:8999, origin:'CN', includedShipping:true, optionNote:'American Standard version. Voltage and delivery confirmation pending.',pricedVariants:[{id:'2502240123311602500',name:'Black · American Standard',retailCents:8999}]},
