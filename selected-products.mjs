...
export const selectedProducts = [
  {"slug":"touchless-kitchen-faucet","lookup":{"pid":"2035225150855884801"},"category":"kitchen","name":"Touchless Kitchen Faucet · Gun Ash","retailCents":12700,"origin":"US","includedShipping":true,"optionNote":"Hands-free automatic kitchen faucet in Gun Ash. Check installation dimensions and power requirements before ordering. Standard shipping included where available; delivery is checked for your ZIP.","pricedVariants":[{"id":"2035225151396950018","name":"Gun Ash","retailCents":12700}]},
  {slug:'commercial-meat-cutter-750w',lookup:{pid:'1992864949234745345'},category:'kitchen',name:'Commercial Meat Cutter · 110V · 750W · 3mm',retailCents:58490,origin:'US',includedShipping:true,optionNote:'Silver commercial meat cutter. Supplier-listed specifications: 110V, 750W and 3mm blade. Standard shipping included where available; delivery is checked for your ZIP.',pricedVariants:[{id:'1992864949385740289',name:'Silver · 110V · 3mm',retailCents:58490}]},
  {slug:'padded-counter-height-stools-set-of-two',lookup:{pid:'2034260265902960642'},category:'kitchen',name:'Padded Counter-Height Bar Stools · Set of 2',retailCents:16669,origin:'US',includedShipping:true,optionNote:'One set includes two counter-height stools with padded seats and high backs, in gray and dark brown. Standard shipping included where available; delivery is checked for your ZIP.',pricedVariants:[{id:'2034260267022839810',name:'Gray and Dark Brown · Set of 2',retailCents:16669}]},
  {slug:'industrial-gray-dining-table',lookup:{pid:'2003353868441661441'},category:'kitchen',name:'70.9-inch Industrial Dining Table · Gray',retailCents:18999,origin:'US',includedShipping:true,optionNote:'Distressed-gray dining table with steel legs, listed by the supplier for up to eight people. Table only; chairs are not included. Standard shipping included where available; delivery is checked for your ZIP.',pricedVariants:[{id:'2003353869997748226',name:'Distressed Gray · Table only',retailCents:18999}]},
