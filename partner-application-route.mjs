...
export async function applicationRoute(req,res,url){
 ...
 try {
  ...
  partnerStore.apply(input);reply(200,'Thank you. Your application has been received for review. If you have already applied with this email, your original application remains on file. Approval and eligible live purchases are required to earn commission.');
